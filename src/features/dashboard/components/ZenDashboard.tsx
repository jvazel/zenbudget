...
import { ChevronLeft, ChevronRight, Calendar, Search, Filter, X } from 'lucide-react'
...
export const ZenDashboard: React.FC = () => {
    ...
    const handleAddSavings = async (goalId: string) => {
        try {
            await savingsService.updateSavingsAmount(goalId, 50) // Default increment for demo
        } catch (e) {
        ...
        <div className="w-full max-w-lg space-y-12 pb-32">
            ...
            <div className="space-y-4">
                <div className="flex flex-col space-y-4 px-2">
                    <div className="flex items-center justify-between">
                        <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-[0.2em]">Flux de Sérénité</p>
                        <button
            ...
            <div className="space-y-6 pt-6">
                <div className="flex justify-between items-center px-2">
                    ...
                    <span className="text-[10px] text-primary font-bold uppercase tracking-widest cursor-pointer hover:underline">Tout voir</span>
                </div>
                    ...
                    {savingsGoals.length > 0 ? (
                        savingsGoals.map(goal => (
                            <ProjectCard
                                ...
                                onFeed={() => handleAddSavings(goal.id)}
                            />
                        ))
                    ) : (
